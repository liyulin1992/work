...
F2837xD_CodeStartBranch.obj: ../F2837xD_CodeStartBranch.asm $(GEN_OPTS) $(GEN_HDRS)
	...
	"C:/ti/ccsv6/tools/compiler/c2000_15.12.3.LTS/bin/cl2000" --include_path="C:/ti/ccsv6/tools/compiler/c2000_15.12.3.LTS/include" --include_path="../../../F2837xD_common/include" --include_path="../../../F2837xD_common/inc" --include_path="../../../F2837xD_common" --include_path="../../../F2837xD_headers/include" --advice:performance=all -g --define=CPU1 --display_error_number --diag_warning=225 --diag_wrap=off --preproc_with_compile --preproc_dependency="F2837xD_CodeStartBranch.d" $(GEN_OPTS__FLAG) "$<"
...
Sci_a.obj: ../Sci_a.c $(GEN_OPTS) $(GEN_HDRS)
	@echo 'Building file: $<'
	@echo 'Invoking: C2000 Compiler'
	"C:/ti/ccsv6/tools/compiler/c2000_15.12.3.LTS/bin/cl2000" --include_path="C:/ti/ccsv6/tools/compiler/c2000_15.12.3.LTS/include" --include_path="../../../F2837xD_common/include" --include_path="../../../F2837xD_common/inc" --include_path="../../../F2837xD_common" --include_path="../../../F2837xD_headers/include" --advice:performance=all -g --define=CPU1 --display_error_number --diag_warning=225 --diag_wrap=off --preproc_with_compile --preproc_dependency="Sci_a.d" $(GEN_OPTS__FLAG) "$<"
	@echo 'Finished building: $<'
	@echo ' '

mian_a.obj: ../mian_a.c $(GEN_OPTS) $(GEN_HDRS)
	@echo 'Building file: $<'
	@echo 'Invoking: C2000 Compiler'
	"C:/ti/ccsv6/tools/compiler/c2000_15.12.3.LTS/bin/cl2000" --include_path="C:/ti/ccsv6/tools/compiler/c2000_15.12.3.LTS/include" --include_path="../../../F2837xD_common/include" --include_path="../../../F2837xD_common/inc" --include_path="../../../F2837xD_common" --include_path="../../../F2837xD_headers/include" --advice:performance=all -g --define=CPU1 --display_error_number --diag_warning=225 --diag_wrap=off --preproc_with_compile --preproc_dependency="mian_a.d" $(GEN_OPTS__FLAG) "$<"
	@echo 'Finished building: $<'
	@echo ' '
